            ...
            <div class="col-lg-8 col-lg-offset-2">
                <div class="col-lg-4 tile-color-3 tile-lg room-tile">
                    ...
                    <div class="tile-content descr" hidden="">
                        ...
                        <a href="booking.php?standardRoom=1">Book now <i class="fa fa-arrow-right"></i></a>
                    </div>
                </div>
                <div class="col-lg-4 tile-color-3 tile-lg room-tile">
                    <div class="tile-content price">
                    ...
                    <div class="tile-content descr" hidden="">
                        ...
                        <a href="booking.php?studentRoom=1">Book now <i class="fa fa-arrow-right"></i></a>
                    </div>
                </div>
                <div class="col-lg-4 tile-color-3 tile-lg room-tile">
                    <div class="tile-content price">
                    ...
                    <div class="tile-content descr" hidden="">
                        ...
                        <a href="booking.php?suiteRoom=1">Book now <i class="fa fa-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
