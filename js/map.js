var map;
function initMap() {
  var stadiumHotel = {lat: -33.934627, lng: 25.603518};
  ...
  var horses = new google.maps.Marker({
      position: {lat: -33.962162, lng: 25.608809},
      map: map,
  ...
  var museum = new google.maps.Marker({
      position: {lat: -33.899428, lng: 25.572550},
      map: map,
  ...
  var reserve = new google.maps.Marker({
      position: {lat: -33.962032, lng: 25.620269},
      map: map,
  ...
  var brewery = new google.maps.Marker({
      position: {lat: -33.965759, lng: 25.623426},
      map: map,
  ...
  var water = new google.maps.Marker({
      position: {lat: -33.971998, lng: 25.645317},
      map: map,
  ...
  var art = new google.maps.Marker({
      position: {lat: -33.965546, lng: 25.611263},
      map: map,
  ...
  var casino = new google.maps.Marker({
      position: {lat: -33.982161, lng: 25.657217},
      map: map,
