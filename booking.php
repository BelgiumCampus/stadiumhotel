...
<div class="row">
    <div class="col-lg-8 col-lg-offset-2">
      ...
      <div class="tab-content">
        <div role="tabpanel" class="tab-pane active" id="rooms"><?php include_once('views/book-room.php')?></div>
        <div role="tabpanel" class="tab-pane" id="conferences"><?php include_once('views/book-conference.php')?></div>
      </div>
    </div>
